...
export class Stage extends BABYLON.Scene {
    ...
    public override enablePhysics(
        gravity?: BABYLON.Nullable<BABYLON.Vector3>,
    ...
    public override enableDepthRenderer(
        camera?: BABYLON.Nullable<BABYLON.Camera>,
        storeNonLinearDepth?: boolean,
        force32bitsFloat?: boolean
    ): BABYLON.DepthRenderer {
        if (!this.renderer) {
            this.renderer = super.enableDepthRenderer(
                camera,
                storeNonLinearDepth,
                force32bitsFloat
            );
